...
public class CheckParameterUpdateMethod { //updatet edilen bilgiler ile orjinel bilgilerin ayni olup olmadigi kontrol edilecek
    ...
    public static boolean checkParameter(User user, BaseUserRequest baseUserRequest){
        ...
        // Bu methodu; karsilastirmal yapilacak tum class larda calisabilmek icin parametre olarak herhangi bir rolun
        ...
        // Bunlardan herhangi birisi true dondururse DeanService classindaki update methodundaki
        // checkDuplicate methodu calisacak
