...
public class LessonProgramRequest {
    ...
    // Ihtiyacimiz olan fieldlari entity class dan kopyalayabilirsin. bunlarin icinde id olmamali cunku id yi
    // kullanici kendisi setleyememeli bunu Springframework yapacak. Teacher ve Studen de olmayacak
    // daha sonra service katinda eklenecekller...
