...
public class StudentRequest extends BaseUserRequest {
    ...
    private Long advisorTeacherId;// Frontend developer dropbox da selection yaptirabilmesi icin getAllAdvisorTeacher
    // endpoint i ile ilgili methodu calistiracak. advisorTeacherId uzerinden teacher larin name lerini dropbox a koyacak.
}